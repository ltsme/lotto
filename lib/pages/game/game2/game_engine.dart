  ...
  Widget getCustomPaint() {
    return GestureDetector(
        ...
        child: Obx(() {
          ...
          return CustomPaint(
            painter: GamePainter(
                _controls, _scheduler._tick.value, _scheduler._term),
          );
        }));
  }

  void _onHorizontalDragStart(DragStartDetails details) {
    _selectedControl = _controls.selectControl(
...
class GameControl {
  ...
  GameControlGroup? getGameControlGroup() {
  ...
  bool _controlCollision(GameControl a, GameControl b) {
    ...
    return _lineCollision(a.x, a.x + a.width, b.x, b.x + b.width) &&
        _lineCollision(a.y, a.y + a.height, b.y, b.y + b.height);
  }

  bool _lineCollision(double s1, double e1, double s2, double e2) {
    return _lineCollisionSub(s1, e1, s2, e2) ||
        _lineCollisionSub(s2, e2, s1, e1);
  }
